                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => PlacePicker(
                                  ...
                                  onPlacePicked: (result) {
                                    print(result.formattedAddress);
                                    hController.actualPositionController.text=result.formattedAddress;
                                    Navigator.of(context).pop();
                                  },
                              ...
                              onTap: () async {
                                Navigator.push(
                                 ...
                                 PlacePicker(
                                   ...
                                   onPlacePicked: (result) {
                                     print(result.formattedAddress);
                                     hController.destinationPositionController.text=result.formattedAddress;
                                     Navigator.of(context).pop();
                                     Navigator.push(
                                       context,
                                       MaterialPageRoute(
                                         builder: (context) =>ResumeTransPage(),
                                       ),
                                     );
                                   },
                                   initialPosition: HomePage().initialPosition,
